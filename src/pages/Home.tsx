    ...
    <div>
      ...
      <Container>
        ...
        <Typography variant="body1" paragraph>
          Welcome to my portfolio website. Here you can find details about my education, experience, skills, and more.
        </Typography>
        <Typography variant="body1" paragraph>
          With a Bachelor's degree in Biochemistry from Northeastern University and extensive experience at renowned institutions like the MIT Koch Institute and Beam Therapeutics, I have developed a strong foundation in structural biology and biochemistry. My work involves cutting-edge research in immunologic and inflammatory mediators of cancer progression, utilizing advanced techniques such as T-cell activation assays, in-vivo mouse tumor model studies, and western blotting.
        </Typography>
        <Typography variant="body1" paragraph>
          I have a proven track record of excellence in laboratory management, including training over 200 lab members in biosafety and blood-borne pathogen protocols. My expertise in high-throughput crystallization screening and protein characterization has been instrumental in advancing numerous research projects.
        </Typography>
        <Box>

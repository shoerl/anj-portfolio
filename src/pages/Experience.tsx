    ...
    <Container>
      ...
      <Box mt={2}>
        ...
        <Typography variant="body1" paragraph>
          ...
          in-vivo mouse tumor model studies, and western blotting. My role also
          includes overseeing lab operations, ensuring compliance with safety
          protocols, and training new researchers.
        </Typography>
      </Box>
      <Box mt={2}>
        <Typography variant="h5" gutterBottom>
        ...
        <Typography variant="body1" paragraph>
          ...
          preparing and isolating proteins for structural characterization using
          AKTA chromatography-based techniques, and collaborating with
          cross-functional teams to advance our research objectives.
        </Typography>
      </Box>
      <Box mt={2}>
        <Typography variant="h5" gutterBottom>
        ...
        <Typography variant="body1" paragraph>
          ...
          overseeing the needs of children in the pediatric department, and
          assisting nurses and doctors with transporting biological samples
